...
class Painting(object):
    def setupUi(self, MainWindow):
        ...
        self.predict_img.setPixmap(QtGui.QPixmap("dependencies/images/start.png"))
    ...
    def predict_action(self):
        self.predict_img.setPixmap(QtGui.QPixmap("dependencies/images/predict.png"))
        img = img_preprocces()
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "paint-gui"))
