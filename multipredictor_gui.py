...
from multipredictor_app import Paintt

class MultiPainting(object):
    def setupUi(self, MainWindow):
        ...
        self.main_image.setPixmap(QtGui.QPixmap("dependencies/images/start.png"))
        ...
        self.predict_button.clicked.connect(self.test)
    ...
    def test(self):
        multi_img_predict()
        self.main_image.setPixmap(QtGui.QPixmap("dependencies/images/multipredict.png")) 

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "multi_paint-gui"))
