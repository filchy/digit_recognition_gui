...
class filchy_layers(object):
    def setupUi(self, MainWindow, activations):
        self.activations = activations

        MainWindow.setObjectName("MainWindow")
        MainWindow.setFixedSize(622, 291)
        MainWindow.setGeometry(800, 331, 622, 291)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "kaggle_layers"))
